...
int *ratePtr = NULL;
short sawToothWave[] = {-1*MAX_SHRT, -(7/8)*MAX_SHRT, -0.75*MAX_SHRT, -(5/8)*MAX_SHRT, -0.50*MAX_SHRT, -(3/8)*MAX_SHRT, -0.25*MAX_SHRT, -(1/8)*MAX_SHRT, 0*MAX_SHRT, (1/8)*MAX_SHRT, 0.25*MAX_SHRT, (3/8)*MAX_SHRT, 0.50*MAX_SHRT, (5/8)*MAX_SHRT, 0.75*MAX_SHRT, (7/8)*MAX_SHRT, 1*MAX_SHRT};
short triangleWave[] = {0*MAX_SHRT, 0.25*MAX_SHRT, 0.50*MAX_SHRT, 0.75*MAX_SHRT, 1*MAX_SHRT, 0.75*MAX_SHRT, 0.50*MAX_SHRT, 0.25*MAX_SHRT, 0*MAX_SHRT, -0.25*MAX_SHRT, -0.50*MAX_SHRT, -0.75*MAX_SHRT, -1*MAX_SHRT, -0.75*MAX_SHRT, -0.50*MAX_SHRT, -0.25*MAX_SHRT, 0*MAX_SHRT};
