...
void button_isr(void){
	...
	newButtonState &= piob->isr;//Read interrupt vector, and with pushed button-value, and enabling next interrupt (Kind of debouncing too...)
	if(newButtonState > 0){
	...
	// } else if(newButtonState == SW4){//Switch04 /*Below code is commented out because: NOT WORKING!*/
	// 	setAbdacOnOff(1);
